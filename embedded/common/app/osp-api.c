...
static SystemDescriptor_t const *_pPlatformDesc = NULL;
...
__weak OSP_CriticalSectionCallback_t EnterCritical = (OSP_CriticalSectionCallback_t)&NullRoutine;
__weak OSP_CriticalSectionCallback_t ExitCritical = (OSP_CriticalSectionCallback_t)&NullRoutine;
 ...
 *
 ***************************************************************************************************/
__weak osp_status_t OSP_RegisterInputSensor(SensorDescriptor_t *pSensorDescriptor,
 ...
 *
 ***************************************************************************************************/
__weak osp_status_t OSP_DoForegroundProcessing(void)
{
 ...
 *
 ***************************************************************************************************/
__weak osp_status_t OSP_DoBackgroundProcessing(void)
{
    _SensorDataBuffer_t data;
    Common_3AxisResult_t AndoidProcessedData;
    //Common_3AxisResult_t algConvention;
 ...
 *
 ***************************************************************************************************/
__weak osp_status_t OSP_SubscribeOutputSensor(SensorDescriptor_t *pSensorDescriptor,
 ...
 *
 ***************************************************************************************************/
__weak osp_status_t OSP_GetVersion(const OSP_Library_Version_t **pVersionStruct)
{

...
#if defined(BOARD_NXP_VALIDATION)
...
static uint32_t channel_completion = 0;
static uint32_t seq_burst_flag = 0;
static uint32_t state = 0;			/* Different ADC conversion mode will be tested when this state flag changes. */
...
int main(void)
{
	...
	Chip_ADC_Calibration(LPC_ADC, 1);
  ...
  /* All pins to inactive, neither pull-up nor pull-down. */
	Chip_IOCON_Config(LPC_IOCON, 0, 29, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 0, 29);
	Chip_IOCON_Config(LPC_IOCON, 0, 30, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 0, 30);
	Chip_IOCON_Config(LPC_IOCON, 0, 31, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 0, 31);
	Chip_IOCON_Config(LPC_IOCON, 1, 0, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 0);
	Chip_IOCON_Config(LPC_IOCON, 1, 1, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 1);
	Chip_IOCON_Config(LPC_IOCON, 1, 2, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 2);
	Chip_IOCON_Config(LPC_IOCON, 1, 3, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 3);
	Chip_IOCON_Config(LPC_IOCON, 1, 4, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 4);
	Chip_IOCON_Config(LPC_IOCON, 1, 5, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 5);
	Chip_IOCON_Config(LPC_IOCON, 1, 6, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 6);
	Chip_IOCON_Config(LPC_IOCON, 1, 7, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 7);
	Chip_IOCON_Config(LPC_IOCON, 1, 8, IOCON_MODE_INACT, IOCON_FUNC1);
	Chip_IOCON_ConfigAnalog(LPC_IOCON, 1, 8);	
#else

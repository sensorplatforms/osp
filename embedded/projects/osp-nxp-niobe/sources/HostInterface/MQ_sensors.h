...
typedef enum _ASensorType {
    A_SENSOR_META_DATA                        = 0,
    A_SENSOR_ACCELEROMETER                    = 1,
    A_SENSOR_GEOMAGNETIC_FIELD                = 2,
    A_SENSOR_MAGNETIC_FIELD                   = A_SENSOR_GEOMAGNETIC_FIELD,
    A_SENSOR_ORIENTATION                      = 3,
    A_SENSOR_GYROSCOPE                        = 4,
    A_SENSOR_LIGHT                            = 5,
    A_SENSOR_PRESSURE                         = 6,
    A_SENSOR_TEMPERATURE                      = 7,
    A_SENSOR_PROXIMITY                        = 8,
    A_SENSOR_GRAVITY                          = 9,
    A_SENSOR_LINEAR_ACCELERATION              = 10,
    A_SENSOR_ROTATION_VECTOR                  = 11,
    A_SENSOR_RELATIVE_HUMIDITY                = 12,
    A_SENSOR_AMBIENT_TEMPERATURE              = 13,
    A_SENSOR_MAGNETIC_FIELD_UNCALIBRATED      = 14,
    A_SENSOR_GAME_ROTATION_VECTOR             = 15,
    A_SENSOR_GYROSCOPE_UNCALIBRATED           = 16,
    A_SENSOR_SIGNIFICANT_MOTION               = 17,
    A_SENSOR_STEP_DETECTOR                    = 18,
    A_SENSOR_STEP_COUNTER                     = 19,
    A_SENSOR_GEOMAGNETIC_ROTATION_VECTOR      = 20,

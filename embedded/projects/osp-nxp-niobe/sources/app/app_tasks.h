...
#ifdef ANDROID_DEMO
ASF_TASK_STATIC( I2CSLAVE_COMM_TASK_ID, I2CCommTask,        150,  (0xa00+STACK_INCREASE),   64 )
#endif
ASF_TASK_STATIC( ALGORITHM_TASK_ID,     AlgorithmTask,      90,  (0xc00+STACK_INCREASE),   64 )
ASF_TASK_STATIC( ALG_BG_TASK_ID,        AlgBackGndTask,     85,  (0x900+STACK_INCREASE),   64 )

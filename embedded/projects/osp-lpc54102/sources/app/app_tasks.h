...
#ifdef ANDROID_DEMO
ASF_TASK_STATIC( I2CSLAVE_COMM_TASK_ID, I2CCommTask,        150,  (0x1080+STACK_INCREASE),   64 )
#endif
ASF_TASK_STATIC( ALGORITHM_TASK_ID,     AlgorithmTask,      90,  (0x1080+STACK_INCREASE),   64 )

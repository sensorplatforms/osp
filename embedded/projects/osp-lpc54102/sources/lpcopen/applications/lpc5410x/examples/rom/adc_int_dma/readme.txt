LPC5410x ADC interrupt/DMA example using the ROM API
=================================

Example description
-------------------
This example shows how to configure the ADC ROM driver to capture
ADC data on sequencer A and B in interrupt mode using FMA. Logged
ADC data will appear on the UART port.
